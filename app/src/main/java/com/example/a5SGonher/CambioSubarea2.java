...
public class CambioSubarea2 extends AppCompatActivity implements DialogOptions2.DialogOptions1Listener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cambio_subarea2);
        ...
        btnAgregarS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ejecutarservicio("https://vvnorth.com/cambiar_subarea.php",nombrePlanta,nombreArea,nombreSubarea);
...
//set image to image view
    ...
    public void openActivity(final String nombrePlanta,final String nombreArea,final String estado)
    {
        ...
        { StringRequest stringRequest= new StringRequest(Request.Method.POST, urlUpload, new Response.Listener<String>() {
            ...
            RequestQueue requestQueue= Volley.newRequestQueue(CambioSubarea2.this);
    ...
    public void onYesClicked() {
        ...
        try {
            ...
            Uri imageUri=  FileProvider.getUriForFile(CambioSubarea2.this,
    ...
    private void ejecutarservicio(String URL,final String NPlanta,final String NArea,final String cambio)
    {
