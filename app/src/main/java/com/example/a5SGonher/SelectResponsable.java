...
public class SelectResponsable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_responsable);
        ...
        buscarProducto("https://vvnorth.com/buscar_responsable.php",nombreSubArea,nombrePlanta,nombreArea);

        //////////////////////////////
    }

    public void boton(final String nombreBoton,int numeroEmpres, final String nombreS, final String nombrePlanta , final String nombreArea,final String nombreAuditor,final String auditor,final String mailAuditor)
    {
        Button myButton3 = new Button(this);
        ...
        myButton3.setOnClickListener(new View.OnClickListener()  {
            ...
            public void onClick(View view) {
                ...
                ejecutarservicio("https://vvnorth.com/insertar_imagens3.php",nombreBoton,nombreS,nombrePlanta,nombreArea,nombreAuditor,mailAuditor);
                //  agregarArea(nombreBoton);

                RegresarAS(nombrePlanta,nombreArea,nombreS);
            }
        });
    }
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                       ...
                       // Auditor=jsonObject.getString("Auditor");
                        mailAuditor=jsonObject.getString("Mail");

                        boton(nombre,i,nombreS,nombrePlanta,nombreArea,nombreAuditor,nombre,mailAuditor);
    ...
    private void ejecutarservicio(String URL,final String nombreBoton, final String nombreS,final String nombrePlanta,final String nombreArea,final String nombreAuditor,final String mailAuditor)
    {
        ...
        })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                parametros.put("NombreAuditor2",nombreAuditor);
                parametros.put("MailAuditor",mailAuditor);
