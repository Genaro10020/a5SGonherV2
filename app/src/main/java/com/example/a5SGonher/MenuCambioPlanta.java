...
public class MenuCambioPlanta extends AppCompatActivity implements ExampleDialog.ExampleDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buscarProducto("https://vvnorth.com/buscar_empresa.php");
    ...
    {
        Intent intent =new Intent(this,CambiarPlanta.class);
