...
public class AuAudit2 extends AppCompatActivity {
    ...
    public void boton(final String nombrePlanta, final String nombreArea,final String nombreSubarea,final String nombreAuditor,final String user,final String nombreSubArea2)
    {
        Button myButton3 = new Button(this);

        myButton3.setText(user +"      "+  nombreSubArea2+"      "+nombreSubarea+"% Terminado");
        ...
        if(nombreSubarea.equals("100")) {
            myButton3.setBackgroundColor(Color.rgb(42, 128, 42));
        }
    ...
    private void buscarProducto2(String URL, final String user,final String nombreSubarea2)
    {
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        boton(nombrePlanta,nombreArea,nombre,nombreAuditor,user,nombreSubarea2);
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                       ...
                       // Toast.makeText(getApplicationContext(), nombreSubarea2, Toast.LENGTH_SHORT).show();
                       ...
                       // boton(nombrePlanta,nombreArea,"nombre",nombreSubarea,nombreSubarea,nombreSubarea);
