...
public class CambiarPlanta extends AppCompatActivity  implements DialogOptions2.DialogOptions1Listener{
    Button btnAgregar;
    EditText edtEmpresa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ejecutarservicio(ServerName+"cambiar_planta.php",nombrePlanta);
                //  openActivity();
            }
        });

        myImageView=(ImageView) findViewById(R.id.imageViewSubArea3);
    ...
    public void onYesClicked() {
        ...
        try {
            ...
            Uri imageUri=  FileProvider.getUriForFile(CambiarPlanta.this,
...
//permision was denied
    ...
    protected void onActivityResult(int requestCode, int resultCode,  Intent data) {
        ...
        if(requestCode==1 && resultCode == RESULT_OK)
        {
            ...
            ImageView imageView =findViewById(R.id.imageViewSubArea3);
