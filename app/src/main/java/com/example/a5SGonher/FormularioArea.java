...
public class FormularioArea extends AppCompatActivity {
    TextView tView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_formulario_area);
       ...
       // tView.setText(nombrePlanta);
        ...
        btnAgregarArea.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ejecutarservicio("https://vvnorth.com/insertar_area.php",nombrePlanta);
    ...
    private void ejecutarservicio(String URL,final String NPlanta)
    {
