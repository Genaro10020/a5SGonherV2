...
public class FormularioUsuario extends AppCompatActivity implements DialogOptions4.DialogOptions1Listener{
    Button btnAgregar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ejecutarservicio("https://vvnorth.com/insertar_auditor.php");
    ...
    public void openActivity(final String estado)
    {
        ...
        if(estado.equals("true"))
         {
             DialogOptions4 dialogOptions4 = new DialogOptions4();
             dialogOptions4.show(getSupportFragmentManager(),"example Dialog2");
        }
        else{
