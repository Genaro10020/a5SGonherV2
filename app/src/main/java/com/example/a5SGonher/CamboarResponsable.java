...
public class CamboarResponsable extends AppCompatActivity {
    Button btnAgregar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camboar_responsable);
        ...
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ejecutarservicio("https://vvnorth.com/cambiar_responsable.php",nombreUsuario);
              //  openActivity();
            }
        });
